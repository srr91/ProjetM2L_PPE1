        ...
        <form method="POST" action="<?= BASE_PATH ?>/index.php?route=auth/register">
            ...
            <div class="form-group">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:0.75rem;">
                    <label style="cursor:pointer; border:1px solid #ddd; border-radius:10px; padding:0.6rem; display:flex; align-items:center; gap:0.6rem; background:#f9f9f9;">
                        <input type="radio" name="role" value="sportif" <?= $role === 'sportif' ? 'checked' : '' ?> required style="margin:0;" onchange="toggleRoleFields()"> Sportif
                    </label>
                    <label style="cursor:pointer; border:1px solid #ddd; border-radius:10px; padding:0.6rem; display:flex; align-items:center; gap:0.6rem; background:#f9f9f9;">
                        <input type="radio" name="role" value="coach" <?= $role === 'coach' ? 'checked' : '' ?> required style="margin:0;" onchange="toggleRoleFields()"> Coach
                    </label>
                </div>
            </div>
