                    ...
                    <li class="profile-dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <?php elseif (($_SESSION['role'] ?? '') === 'coach'): ?>
                                <a href="<?= BASE_PATH ?>/old/espace-coach/dashboard.php" class="dropdown-item"><span class="dropdown-icon">📊</span> Tableau de bord</a>
                                <a href="<?= BASE_PATH ?>/old/espace-coach/profil.php" class="dropdown-item"><span class="dropdown-icon">👤</span> Profil utilisateur</a>
                                <a href="<?= BASE_PATH ?>/old/espace-coach/seances.php" class="dropdown-item"><span class="dropdown-icon">📅</span> Mes séances</a>
