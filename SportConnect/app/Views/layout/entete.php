                    ...
                    <li class="profile-dropdown">
                        ...
                        <div class="dropdown-menu">
                            <?php if (($_SESSION['role'] ?? '') === 'admin'): ?>
                                <a href="<?= BASE_PATH ?>/administration/dashboard.php" class="dropdown-item"><span class="dropdown-icon">📊</span> Tableau de bord</a>
                                <a href="<?= BASE_PATH ?>/administration/utilisateurs.php" class="dropdown-item"><span class="dropdown-icon">👥</span> Utilisateurs</a>
                                <a href="<?= BASE_PATH ?>/administration/seances.php" class="dropdown-item"><span class="dropdown-icon">📅</span> Séances</a>
                                <a href="<?= BASE_PATH ?>/administration/avis.php" class="dropdown-item"><span class="dropdown-icon">⭐</span> Avis</a>
                            <?php elseif (($_SESSION['role'] ?? '') === 'coach'): ?>
                                <a href="<?= BASE_PATH ?>/espace-coach/dashboard.php" class="dropdown-item"><span class="dropdown-icon">📊</span> Tableau de bord</a>
                                <a href="<?= BASE_PATH ?>/espace-coach/profil.php" class="dropdown-item"><span class="dropdown-icon">👤</span> Profil utilisateur</a>
                                <a href="<?= BASE_PATH ?>/espace-coach/seances.php" class="dropdown-item"><span class="dropdown-icon">📅</span> Mes séances</a>
                                <a href="<?= BASE_PATH ?>/espace-coach/avis.php" class="dropdown-item"><span class="dropdown-icon">⭐</span> Mes avis</a>
                                <a href="<?= BASE_PATH ?>/espace-coach/messages.php" class="dropdown-item">
                            ...
                            <?php else: ?>
                                <a href="<?= BASE_PATH ?>/espace-sportif/dashboard.php" class="dropdown-item"><span class="dropdown-icon">📊</span> Tableau de bord</a>
                                <a href="<?= BASE_PATH ?>/espace-sportif/profil.php" class="dropdown-item"><span class="dropdown-icon">👤</span> Profil utilisateur</a>
                                <a href="<?= BASE_PATH ?>/espace-sportif/progression.php" class="dropdown-item"><span class="dropdown-icon">📈</span> Ma progression</a>
                                <a href="<?= BASE_PATH ?>/index.php?route=coachs" class="dropdown-item"><span class="dropdown-icon">🔍</span> Trouver un coach</a>
                                <a href="<?= BASE_PATH ?>/espace-sportif/messages.php" class="dropdown-item">
                                    <span class="dropdown-icon">💬</span> Messages
                                    <span data-sc-messages-badge style="display:none; margin-left: 8px; min-width: 22px; height: 22px; padding: 0 7px; border-radius: 999px; background: #DC3545; color: #fff; font-weight: 800; font-size: 0.8rem; align-items: center; justify-content: center;"></span>
                                </a>
                            <?php endif; ?>
