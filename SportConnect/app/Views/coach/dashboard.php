...
<div class="container" style="margin-top: 2rem;">
    ...
    <div class="grid grid-3" style="margin-top: 2rem;">
        <a href="<?= BASE_PATH ?>/old/espace-coach/profil.php" class="card" style="text-decoration: none; color: inherit; text-align: center;">
            <div style="font-size: 3rem; margin-bottom: 1rem;">👤</div>
        ...
        <a href="<?= BASE_PATH ?>/old/espace-coach/avis.php" class="card" style="text-decoration: none; color: inherit; text-align: center;">
            <div style="font-size: 3rem; margin-bottom: 1rem;">⭐</div>
            <h3>Mes avis</h3>
