...
<div class="container" style="margin-top: 3rem;">
    ...
    <div class="card" style="max-width: 900px; margin: 0 auto;">
        ...
        <div style="border-bottom: 1px solid var(--border); padding: 2rem 0;">
            ...
            <p style="color: var(--gray);">
                Utilisez notre <a href="/pages/contact.php" style="color: var(--primary);">formulaire de contact</a> 
        ...
        <div style="padding: 2rem 0;">
            ...
            <p style="color: var(--gray);">
                ...
                <a href="/pages/conditions-utilisation.php" style="color: var(--primary);">conditions d'utilisation</a>.
            </p>
        </div>
