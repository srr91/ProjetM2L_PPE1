...
<head>
    ...
    <link rel="stylesheet" href="/ressources/styles/style.css?v=<?= time() ?>">
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                ...
                <div class="logo" style="display: flex; align-items: center; gap: 1rem;">
                    <?php if (!empty($photo_profil) && file_exists(__DIR__ . '/../../telechargements/profils/' . $photo_profil)): ?>
                        <img src="/telechargements/profils/<?= htmlspecialchars($photo_profil) ?>" 
                             alt="Photo de profil" 
  ...
  <rect x="272" y="80" width="222" height="3" rx="2" fill="url(#teal)" opacity="0.7"/>
            ...
            <ul class="nav-links">
                <?php if (isset($_SESSION['user_id'])): ?>
                    ...
                    <li><a href="/coachs.php">NOS COACHS</a></li>
                    ...
                    <li class="profile-dropdown">
                        ...
                        <div class="dropdown-menu">
                            <?php if ($_SESSION['role'] === 'admin'): ?>
                                <a href="/administration/dashboard.php" class="dropdown-item">
                                    <span class="dropdown-icon">📊</span> Tableau de bord
                                </a>
                                <a href="/administration/utilisateurs.php" class="dropdown-item">
                                    <span class="dropdown-icon">👥</span> Utilisateurs
                                </a>
                                <a href="/administration/seances.php" class="dropdown-item">
                                    <span class="dropdown-icon">📅</span> Séances
                                </a>
                                <a href="/administration/avis.php" class="dropdown-item">
                                    <span class="dropdown-icon">⭐</span> Avis
                                </a>
                            <?php elseif ($_SESSION['role'] === 'coach'): ?>
                                <a href="/espace-coach/dashboard.php" class="dropdown-item">
                                    <span class="dropdown-icon">📊</span> Tableau de bord
                                </a>
                                <a href="/espace-coach/profil.php" class="dropdown-item">
                                    <span class="dropdown-icon">👤</span> Profil utilisateur
                                </a>
                                <a href="/espace-coach/seances.php" class="dropdown-item">
                                    <span class="dropdown-icon">📅</span> Mes séances
                                </a>
                                <a href="/espace-coach/avis.php" class="dropdown-item">
                                    <span class="dropdown-icon">⭐</span> Mes avis
                                </a>
                                <a href="/espace-coach/messages.php" class="dropdown-item">
                            ...
                            <?php else: ?>
                                <a href="/espace-sportif/dashboard.php" class="dropdown-item">
                                    <span class="dropdown-icon">📊</span> Tableau de bord
                                </a>
                                <a href="/espace-sportif/profil.php" class="dropdown-item">
                                    <span class="dropdown-icon">👤</span> Profil utilisateur
                                </a>
                                <a href="/espace-sportif/progression.php" class="dropdown-item">
                                    <span class="dropdown-icon">📈</span> Ma progression
                                </a>
                                <a href="/coachs.php" class="dropdown-item">
                                    <span class="dropdown-icon">🔍</span> Trouver un coach
                                </a>
                                <a href="/espace-sportif/messages.php" class="dropdown-item">
                                    <span class="dropdown-icon">💬</span> Messages
                                    <span data-sc-messages-badge style="display:none; margin-left: 8px; min-width: 22px; height: 22px; padding: 0 7px; border-radius: 999px; background: #DC3545; color: #fff; font-weight: 800; font-size: 0.8rem; align-items: center; justify-content: center;"></span>
                                </a>
                            <?php endif; ?>
                            <div class="dropdown-divider"></div>
                            <a href="/authentification/deconnexion.php" class="dropdown-item logout">
                ...
                <?php else: ?>
                    ...
                    <li><a href="/pages/faq.php">FAQ</a></li>
                    <li><a href="/pages/contact.php">CONTACT</a></li>
                    <li><a href="/authentification/connexion.php">CONNEXION</a></li>
                    <li><a href="/authentification/inscription.php" class="btn-primary" style="background: #FFD700; color: #1E1E1E; padding: 0.75rem 1.5rem; border-radius: 0; font-weight: 700;">INSCRIPTION</a></li>
                <?php endif; ?>
            </ul>
        </div>
    </nav>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function scMaybeNotify(groups) {
            ...
            for (let i = 0; i < keys.length; i++) {
                ...
                n.onclick = function() {
                    const base = (scRole === 'coach') ? '/espace-coach/messages.php?with=' : '/espace-sportif/messages.php?with=';
        ...
        async function scPoll() {
            ...
            scInFlight = true;
            try {
                const url = '/api/actualisation-messages.php?last_id=' + encodeURIComponent(scLastId);
