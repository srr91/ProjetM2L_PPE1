        ...
        <div class="container">
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 3rem; margin-bottom: 2rem;">
                ...
                <div>
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        <li style="margin-bottom: 0.75rem;">
                            <a href="/coachs.php" style="color: var(--gray); text-decoration: none; transition: color 0.3s; cursor: pointer;" 
                        ...
                        <li style="margin-bottom: 0.75rem;">
                            <a href="/inscription.php?role=coach" style="color: var(--gray); text-decoration: none; transition: color 0.3s; cursor: pointer;" 
                               onmouseover="this.style.color='var(--primary)'" 
                               onmouseout="this.style.color='var(--gray)'">
                                Devenir coach
                            </a>
                        ...
                        <li style="margin-bottom: 0.75rem;">
                            <a href="/index.php#apropos" style="color: var(--gray); text-decoration: none; transition: color 0.3s; cursor: pointer;" 
                               onmouseover="this.style.color='var(--primary)'" 
                               onmouseout="this.style.color='var(--gray)'">
                                À propos
                            </a>
                ...
                <div>
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        <li style="margin-bottom: 0.75rem;">
                            <a href="/pages/faq.php" style="color: var(--gray); text-decoration: none; transition: color 0.3s; cursor: pointer;" 
                               onmouseover="this.style.color='var(--primary)'" 
                               onmouseout="this.style.color='var(--gray)'">
                                FAQ
                            </a>
                        ...
                        <li style="margin-bottom: 0.75rem;">
                            <a href="/pages/contact.php" style="color: var(--gray); text-decoration: none; transition: color 0.3s; cursor: pointer;" 
                               onmouseover="this.style.color='var(--primary)'" 
                               onmouseout="this.style.color='var(--gray)'">
                                Contact
                            </a>
                        ...
                        <li style="margin-bottom: 0.75rem;">
                            <a href="/pages/conditions-utilisation.php" style="color: var(--gray); text-decoration: none; transition: color 0.3s; cursor: pointer;" 
                               onmouseover="this.style.color='var(--primary)'" 
                               onmouseout="this.style.color='var(--gray)'">
