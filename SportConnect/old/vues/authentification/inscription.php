...
<div class="container" style="max-width: 900px; margin-top: 3rem; margin-bottom: 3rem;">
    <div class="card">
        ...
        <form method="POST" action="/authentification/inscription.php">
            ...
            <div class="form-group" style="margin-top: 1.5rem;">
                <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
                    ...
                    <span>J'accepte les <a href="/conditions-utilisation.php" target="_blank" style="color: var(--primary);">conditions d'utilisation</a> et la politique de confidentialité</span>
                </label>
            </div>
        ...
        <p style="text-align: center; margin-top: 2rem; padding-top: 2rem; border-top: 1px solid var(--border); color: var(--gray);">
            Déjà un compte ? 
            <a href="/authentification/connexion.php" style="color: var(--primary); font-weight: 700; text-decoration: none;">
                Se connecter →
            </a>
        </p>
    </div>
