    ...
    <div class="card">
        ...
        <form method="POST" action="/authentification/connexion.php">
            ...
            <div style="text-align: right; margin-bottom: 1rem;">
                <a href="/authentification/mot-de-passe-oublie.php" style="color: var(--primary); font-size: 0.9rem; text-decoration: none;">
                    Mot de passe oublié ?
                </a>
            </div>
        ...
        <p style="text-align: center; margin-top: 1.5rem; color: var(--gray);">
            ...
            <a href="/inscription.php" style="color: var(--primary); font-weight: 600;">
                S'inscrire
            </a>
        </p>
